...
Public Class frmActividadesComite
    ...
    Private Sub CargarActividadesComite()
        ...
        str.Append("<chart caption='Cantidad de Actividades por Comité' subCaption='(Corresponde a toda la información histórica)' formatnumberscale='0' xaxisname='Comité' yaxisname='Cantidad de Actividades' theme='fint'>")
