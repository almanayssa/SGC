...
function url() {
            ...
            hidden = open('PrecioBungalow.aspx', 'NewWindow','top=0,left=0, width=500,height=50,status=yes, resizable=no,scrollbars=yes');

            }

            function url2(page) {

            hidden = open(page,'NewWindow','top=200,left=120, width=705,height=300,status=yes, resizable=no,scrollbars=yes');

            }

            function url3() {

            hidden = open('HistoricoReservas.aspx', 'NewWindow','top=0,left=0, width=1000,height=500,status=yes, resizable=no,scrollbars=yes');

            }



function contarletras(ctr){
    //alert(document.getElementById(ctr).value);
     //alert(document.getElementById(ctr).value.length);
     var conta = document.getElementById(ctr).value.length;
     if (conta > 4) {
     alert(document.getElementById(ctr).value.length);
     }
}
...
/*
            ...
            $('#<% = Txtcalle.ClientID %>').keyup(function() {
