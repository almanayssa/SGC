<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/PlantillaSGC.master" CodeBehind="frmRecuperarContrasena.aspx.vb" Inherits=".frmSolicitarContrasenia" %>
...
<div class="DatosSocio" style="height: 370px">
                    ...
                    <br />
                    <br />
                    <a id="HyperLink1" href="index.aspx" target="_self" style="color:#82AE1D;font-weight:bold;">Regresar</a><br />
    </div>    
    <br />
    <br />
</asp:Content>
