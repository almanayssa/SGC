...
<table border="0" cellpadding="0" cellspacing="0">
	<tr>
	    ...
	    <td valign="top" style="padding:0px 10px 10px 10px; border-right:solid 1px #FFFFFF; width:200px;">
            <table border="0" cellpadding="0" cellspacing="0"><tr><td class="generalImageTitle"><asp:Image ID="imgSectionTitleImage1" SkinID="imgSectionTitleImage" runat="server" ImageUrl="~/imagenes/botones/calendar2.png" /></td><td>&nbsp;</td><td class="generalTextSectionTitle" style="width:250px;"><span style="font-size:small;">Calendario de Actividades</span></td></tr></table><br />
	        <table border="0" cellpadding="0" cellspacing="0">
	            <tr>
                            ...
                            <tr>                                
                                ...
                                <td class="contentEventsLinks">
                                    <table border="0" cellpadding="0" cellspacing="0" id="tblRegisterNow" runat="server"
                                        ...
                                        <tr>
                                            <td>
                                                <asp:ImageButton ID="ibtnInscribirse" runat="server" ImageUrl="~/imagenes/botones/inscribir.jpg" Visible='<%#Eval("flg_registro") %>' PostBackUrl='<%#String.Concat("~/frmRegistroInscripcion.aspx?", Eval("id_actividad")) %>' />                                                
                                            </td>
                                        </tr>
                                    </table>
                                </td>
